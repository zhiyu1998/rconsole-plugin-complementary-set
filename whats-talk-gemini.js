...
export class WhatsTalkGemini extends plugin {
    constructor() {
        super({
            name: "[R插件补集]他们在聊什么-Gemini版本",
    ...
    async chat(messages, memberCount) {
        ...
        const result = await client.generateContent([prompt, messages.join("\n")]);
